						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3">Price in Rupiah</div>
								</div>
							</div>
						...
						<div style="width:300px;">
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									...
									<p><br/></p>
									<a href="/kwu/user/login" style="color:white; list-style:none;">Login Admin</a><input type="submit" class="btn btn-success" style="float:right;" id="login" value="Login">
								</div>
